...
class SaveModelCllaBack(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        if((epoch+1)%epochs_per_save==0):
            ...
            temp_model.save('./models/test16_run_for_model_conv/Test_37_9_2_byte3_newest.hdf5')
            if((epoch+epoch_offset+1)%25==0):
                temp_model.save('./models/test16_run_for_model_conv/Test_37_9_2_byte3_epoch{:0>6d}.hdf5'.format(epoch+epoch_offset+1))
            ...
            plot_weights_of_layer1_and_att(temp_model,trs_file_path,fixed_shift_array)
...
fixed_shift_array = np.random.randint(-shift_scale,shift_scale,size=(60000,))
